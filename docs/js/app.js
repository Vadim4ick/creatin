                            ...
                            for (var l in i[o])
                              if (l === n)
                                if (void 0 === t)
                                  ...
                                  s.push({ ev: o, namespace: l, handler: t });
                        return s;
                      }
                      if (c(this[0]) && e) {
                  ...
                  var p = {
                    keydownEvent: function (e) {
                      ...
                      if (
                        ...
                        (e.ctrlKey && f === r.default.X && !("oncut" in u))
                      )
                        e.preventDefault(),
                    ...
                    keypressEvent: function (e, t, i, n, s) {
                      ...
                      if (m) {
                        ...
                        var v,
                          g = t ? { begin: s, end: s } : a.caret.call(c, f),
                    ...
                    pasteEvent: function (e) {
                      ...
                      i.isRTL &&
                        ((t = s.end),
                        (s.end = a.translatePosition.call(i, s.begin)),
                        (s.begin = a.translatePosition.call(i, t)));
                    ...
                    cutEvent: function (e) {
                      var t = this.inputmask,
                        ...
                        s = a.caret.call(t, n),
                        c = t.isRTL
                          ? a.getBuffer.call(t).slice(s.end, s.begin)
                          : a.getBuffer.call(t).slice(s.begin, s.end),
                      ...
                      window.navigator.clipboard
                        ...
                        o.handleRemove.call(t, n, r.default.DELETE, s),
                        (0, l.writeBuffer)(
                          n,
                          a.getBuffer.call(t),
                          i.p,
                      ...
                      if (r.inputmask) {
                        ...
                        "" !== s &&
                          (i.clearMaskOnLostFocus &&
                            (-1 === a.getLastValidPosition.call(t) &&
                            s === a.getBufferTemplate.call(t).join("")
                              ? (c = [])
                  ...
                  n.default.extendAliases({
                    datetime: {
                      ...
                      onUnMask: function (e, t, i) {
                        return t
                          ? S(i.outputFormat, P(e, i.inputFormat, i), i, !0)
                          : t;
                      },
                ...
                7760: function (e, t, i) {
                  ...
                  function p(e, t, i, n, a) {
                    ...
                    if (
                      ...
                      var w,
                        E,
                        x = s.seekNext.call(l, -1, void 0, !1);
                      if (
                        ...
                        for (var S = x; void 0 !== (w = b.shift()); ) {
                          ...
                          if (
                            ...
                            (T.keyCode = E.input.charCodeAt(0)),
                            (g = c.EventHandlers.keypressEvent.call(
                              l,
                              T,
                              !0,
                        ...
                        if (f) b();
                          ...
                          switch (s.charAt(0)) {
                            ...
                            case i.quantifiermarker[0]:
                              ...
                              ("*" !== _ && "+" !== _) ||
                                (_ = "*" === C ? 0 : 1),
                                (S.quantifier = { min: _, max: C, jit: M });
                              var L =
                                m.length > 0
                                  ? m[m.length - 1].matches
                                  : h.matches;
                              if ((n = L.pop()).isAlternator) {
                                L.push(n), (L = n.matches);
                                var O = new a.default(!0),
                                  A = L.pop();
                                L.push(O), (L = O.matches), (n = A);
                              }
                              n.isGroup || (n = k([n])), L.push(n), L.push(S);
                              break;
                        ...
                        return (
                          ...
                          !0 === t
                            ? ((s = {
                              ...
                              !0 !== t &&
                                ((r.default.prototype.masksCache[o] = s),
                                (s = n.default.extend(
                                  !0,
                                  {},
                      ...
                      do {
                        if (!0 === e && d.validPositions[y])
                          ...
                          ("number" == typeof b && isFinite(b) && b > y)
                            ? g.push(!1 === i ? h.nativeDef : o.call(r, y, h))
                            : (v = !1);
                        }
                        y++;
                    ...
                    function b(t, i, r, s) {
                      function o(r, s, c) {
                        ...
                        if (h === e && void 0 === r.matches) {
                          ...
                          if (r.isGroup && c !== r) {
                            if (
                              (r = o(t.matches[t.matches.indexOf(r) + 1], s, c))
                            )
                              return !0;
                            ...
                            if (-1 === L || "string" == typeof L) {
                              ...
                              for (var $ = 0; $ < I.length; $++) {
                                (O = parseInt(I[$])),
                                  (v = []),
                                  (i =
                                    ("string" == typeof L && m(h, O, C)) ||
                                    D.slice());
                                var G = T.matches[O];
                                if (G && o(G, [O].concat(s), c)) r = !0;
                                else if (
                                  (0 === $ && (M = !0),
                                  G &&
                                    G.matches &&
                            ...
                            for (
                              var W = r, K = i.length > 0 ? i.shift() : 0;
                              K <
                ...
                7215: function (e, t, i) {
                  Object.defineProperty(t, "__esModule", { value: !0 }),
                    ...
                    (t.handleRemove = function (e, t, i, n, o) {
                      ...
                      if (
                        ...
                        !0 !== n &&
                          ((d.p =
                            t === r.default.DELETE ? i.begin + f : i.begin),
                  ...
                  function l(e, t, i, n, r, o) {
                    var c,
                      ...
                      x = this.opts,
                      S = w.maskset,
                      T = E.extend(!0, {}, S.validPositions),
                      P = E.extend(!0, {}, S.tests),
                      _ = !1,
                      C = !1,
                      M = void 0 !== r ? r : s.getLastValidPosition.call(w);
                    if (
                      (o &&
                        ((b = o.begin),
                        (k = o.end),
                    ...
                    if (void 0 !== d) {
                      ...
                      for (
                        ...
                        if (
                          ...
                          (S.validPositions = E.extend(!0, {}, T)),
                          (S.tests = E.extend(!0, {}, P)),
                          !S.excludes[v])
                        ) {
                          C = l.call(w, e, t, i, n, v - 1, o);
                          break;
                        }
                    ...
                    return (
                      (C && !1 === x.keepStatic) || delete S.excludes[v], C
                    );
                  }
                  function c(e, t, i) {
                    var n = this.opts,
                    ...
                    switch (n.casing || t.casing) {
                      ...
                      case "title":
                        ...
                        e =
                          0 === i ||
                          (s &&
                            s.input === String.fromCharCode(r.default.SPACE))
                            ? e.toUpperCase()
                            : e.toLowerCase();
                        break;
                      default:
                  ...
                  function p(e, t, i, n, r, o, f) {
                          ...
                          if (
                            ...
                            !1 !==
                              (o =
                                ...
                                (null != p.fn
                                  ? p.fn.test(i, k, t, r, b, u.call(g, e))
                                  : (i === p.def ||
                    ...
                    if (
                      ...
                      for (var P = w; P < (g.isRTL ? e.begin : e.end); P++)
                        void 0 !== k.excludes[P] &&
                    ...
                    if (
                      ...
                      if (
                        ...
                        } else S = { caret: s.seekNext.call(g, w) };
                      }
                      !1 !== S ||
                      !b.keepStatic ||
                      (!d.call(g, s.getBuffer.call(g)) && 0 !== w) ||
                      i ||
                      !0 === r
                        ? u.call(g, e) &&
                          k.tests[w] &&
                  ...
                  function f(e, t, i) {
                    ...
                    return (
                      !1 === r &&
                        ...
                        (r = f.call(this, e + n.jitOffset[e], t, i)),
                      r
                    );
                  }
                  function h(e, t, i) {
                  ...
                  function v(e, t, i, n) {
                    ...
                    if (
                      ...
                      for (
                        ...
                        if (
                          ...
                          for (; "" !== a.getTest.call(r, x).match.def; ) {
                            ...
                            if ((!v && s.getBuffer.call(r), x > o.maskLength))
                              break;
                            x++;
                          }
                          "" == a.getTest.call(r, x).match.def && (v = !1),
                            (x = E);
                        }
                        if (!v) break;
                      }
                      ...
                      t &&
                        ...
                        (o.validPositions[n] = c.extend(!0, {}, t));
                    return s.resetMaskSet.call(r, !0), u;
                  }
                },
                5581: function (e) {
      ...
      732: function (e) {
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            Q = function (e, t) {
              X(e, u, E(e, t.data_sizes)),
                X(e, d, E(e, t.data_srcset)),
                X(e, c, E(e, t.data_src));
            },
            Z = {
              IMG: function (e, t) {
                R(e, function (e) {
              ...
              VIDEO: function (e, t) {
                N(e, function (e) {
                  ...
                  W(e, G),
                  X(e, p, E(e, t.data_poster)),
                  X(e, c, E(e, t.data_src)),
                  e.load();
              },
              OBJECT: function (e, t) {
                W(e, V), X(e, h, E(e, t.data_src));
              },
            },
                    ...
                    !(function (e) {
                      ...
                      (function (e, t, i) {
                        var n = E(e, t.data_bg_multi),
                          ...
                          s = r && a ? a : n;
                        s && ((e.style.backgroundImage = s), U(e, t, i));
                      })(e, t, i),
                      (function (e, t, i) {
  ...
  (() => {
    ...
    const F = {
      ...
      updateSlides: function () {
        ...
        for (let a = 0; a < u; a += 1) {
          ...
          const s = d.eq(a);
          if (
            (x && e.grid.updateSlide(a, s, u, t), "none" !== s.css("display"))
          ) {
            if ("auto" === n.slidesPerView) {
              ...
              if (
                ...
                S = e.isHorizontal() ? s.outerWidth(!0) : s.outerHeight(!0);
              else {
                const e = i(r, "width"),
                  t = i(r, "padding-left"),
                  n = i(r, "padding-right"),
    ...
    class de {
      constructor(...e) {
        ...
        (n.__swiper__ = !0),
          (n.support = R()),
          (n.device = N({ userAgent: i.userAgent })),
          (n.browser = $()),
          (n.eventsListeners = {}),
    ...
    function fe({ swiper: e, extendParams: t, on: i, emit: n }) {
      ...
      (e.autoplay = { running: !1, paused: !1 }),
        ...
        Object.assign(e.autoplay, { pause: l, run: r, start: s, stop: o });
    }
    function he() {
    ...
    window.addEventListener("load", function (e) {
      he(),
        ...
        document.querySelector(".clients-about__slider") &&
          new ue(".clients-about__slider", {
            modules: [pe, fe],
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
    ...
    new (i(732))({ elements_selector: "[data-src],[data-srcset]" });
    e.watcher = new (class {
      constructor(e) {
    ...
    new ve("max").init();
    const ge = document.querySelector(".main-projects");
    if (
      (ge &&
          ...
          e.forEach((e) => {
            e.isIntersecting
              ? (document.querySelector("header").classList.add("black"),
                (document.querySelector(".heder__logo").innerHTML =
      ...
      const e = document.querySelector(".main-projects");
      ye.observe(e);
    }
    (window.FLS = !0),
      (function (e) {
            ...
            (n = Array.from(n).filter((t) => t.closest("[data-tabs]") === e)),
              ...
              r.forEach((r, s) => {
                t.matches
                  ...
                  : (i.append(n[s]), e.classList.remove("_tab-spoller"));
              });
          });
        }
        function r(e) {
        ...
        async function n(e, i) {
          if (0 === (t ? u.getErrors(e) : 0)) {
            if (e.hasAttribute("data-ajax")) {
              ...
              const s = await fetch(t, { method: n, body: r });
              if (s.ok) {
                await s.json();
      ...
      (function () {
        ...
        const e = document.querySelector("header.header"),
          ...
          i = e.hasAttribute("data-scroll-show"),
